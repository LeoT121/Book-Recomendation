package com.Leo.BookRecomendation.config;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers("/css/**", "/js/**", "/image/**").permitAll()  // Recursos estáticos
                .requestMatchers("/usuario/imagen/**").permitAll()
                ...
                .requestMatchers("/favoritos", "/libros").authenticated()
